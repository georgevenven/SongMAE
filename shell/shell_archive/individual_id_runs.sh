...
IID_LINEAR_PROBE_MODEL="${IID_LINEAR_PROBE_MODEL:-logistic_regression}"
IID_LINEAR_C="${IID_LINEAR_C:-1.0}"
IID_LINEAR_MAX_ITER="${IID_LINEAR_MAX_ITER:-2000}"
IID_LINEAR_MLP_HIDDEN_DIM="${IID_LINEAR_MLP_HIDDEN_DIM:-512}"
IID_LINEAR_MLP_EPOCHS="${IID_LINEAR_MLP_EPOCHS:-100}"
IID_LINEAR_MLP_BATCH_SIZE="${IID_LINEAR_MLP_BATCH_SIZE:-1024}"
IID_LINEAR_MLP_LR="${IID_LINEAR_MLP_LR:-0.001}"
IID_LINEAR_MLP_WEIGHT_DECAY="${IID_LINEAR_MLP_WEIGHT_DECAY:-0.0001}"
...
set_bird_config() {
  ...
  case "$bird" in
    zf)
      ...
      IID_ANNOTATION_JSON="$ROOT/files/annotation jsons/zf_annotations.json"
    ...
    bf)
      ...
      IID_ANNOTATION_JSON="$ROOT/files/annotation jsons/bf_annotations.json"
      IID_WAV_ROOT="/media/george-vengrovski/disk2/raw_data/wav_files_canary_zf_bf_songmae"
      IID_SONGS_PER_BIRD="${IID_SONGS_PER_BIRD_OVERRIDE:-30}"
      IID_POOL_WINDOW="${IID_POOL_WINDOW_OVERRIDE:-30}"
      IID_POOL_HOP="${IID_POOL_HOP_OVERRIDE:-5}"
    ...
    canary)
      ...
      IID_ANNOTATION_JSON="$ROOT/files/annotation jsons/canary_annotations_for_individual_id.json"
    ...
    chiffchaff)
      ...
      IID_ANNOTATION_JSON="$ROOT/files/annotation jsons/chiffchaff_annotations.json"
    ...
    european_starling|starling)
      ...
      IID_ANNOTATION_JSON="$ROOT/files/annotation jsons/european_starling_annotations.json"
    ...
    tree_pipit)
      ...
      IID_ANNOTATION_JSON="$ROOT/files/annotation jsons/tree_pipit_annotations.json"
    ...
    little_owl)
      ...
      IID_ANNOTATION_JSON="$ROOT/files/annotation jsons/little_owl_annotations.json"
    ...
    orangutan)
      ...
      IID_ANNOTATION_JSON="$ROOT/files/annotation jsons/orangutan_annotations.json"
    ...
    ovenbird|lapp_ovenbird)
      ...
      IID_ANNOTATION_JSON="$ROOT/files/annotation jsons/lapp_ovenbird.json"
...
set_output_dirs() {
  ...
  local linear_probe_tag=""
  if [[ "$IID_LINEAR_PROBE_MODEL" != "logistic_regression" ]]; then
    linear_probe_tag="_${IID_LINEAR_PROBE_MODEL}"
  fi
  ...
  IID_LINEAR_OUT_DIR="$ROOT/results/individual_id_linear_probe/${IID_BIRD_KEY}_${linear_encoder_tag}${linear_norm_tag}_${IID_MODEL_TAG}_${linear_aug_tag}${linear_probe_tag}${linear_postprocess_tag}_w${IID_POOL_WINDOW}_h${IID_LINEAR_POOL_HOP}"
...
run_suite() {
  ...
  export IID_LINEAR_OUT_DIR IID_LINEAR_VAL_FRACTION IID_LINEAR_PROBE_MODEL IID_LINEAR_C IID_LINEAR_MAX_ITER IID_LINEAR_MLP_HIDDEN_DIM IID_LINEAR_MLP_EPOCHS IID_LINEAR_MLP_BATCH_SIZE IID_LINEAR_MLP_LR IID_LINEAR_MLP_WEIGHT_DECAY IID_LINEAR_FEATURE_POSTPROCESS IID_LINEAR_FEATURE_POSTPROCESS_DIM IID_LINEAR_POOL_HOP IID_LINEAR_NORMALIZATION_PRESET IID_LINEAR_SONGMAE_EMBEDDING_VARIANT IID_LINEAR_WINDOW_MEAN_POOL IID_LINEAR_WINDOW_CONCAT IID_LINEAR_WINDOW_TOKEN_PROBE
