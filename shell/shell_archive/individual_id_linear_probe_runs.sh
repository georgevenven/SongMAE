...
cmd=(
  ...
  --probe_model "$IID_LINEAR_PROBE_MODEL"
  --c "$IID_LINEAR_C"
  --max_iter "$IID_LINEAR_MAX_ITER"
  --mlp_hidden_dim "$IID_LINEAR_MLP_HIDDEN_DIM"
  --mlp_epochs "$IID_LINEAR_MLP_EPOCHS"
  --mlp_batch_size "$IID_LINEAR_MLP_BATCH_SIZE"
  --mlp_lr "$IID_LINEAR_MLP_LR"
  --mlp_weight_decay "$IID_LINEAR_MLP_WEIGHT_DECAY"
  --feature_postprocess "$IID_LINEAR_FEATURE_POSTPROCESS"
  --feature_postprocess_dim "$IID_LINEAR_FEATURE_POSTPROCESS_DIM"
)
