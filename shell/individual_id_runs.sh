...
set_output_dirs() {
  ...
  IID_UMAP_OUT_DIR="$ROOT/results/individual_id_umap/${IID_BIRD_KEY}_${IID_MODEL_TAG}${pool_layout_tag}_w${IID_POOL_WINDOW}_h${IID_POOL_HOP}"
...
run_suite() {
  ...
  export IID_ENCODER IID_RECORDING_MODE IID_SONGS_PER_BIRD IID_MAX_BIRDS IID_SEED IID_POOL_WINDOW IID_POOL_HOP IID_POOL_MODE IID_POOL_LAYOUT
