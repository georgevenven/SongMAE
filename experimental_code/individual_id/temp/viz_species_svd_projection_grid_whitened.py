...
for i, ((species, stem, extracted), features) in enumerate(zip(items, whitened_features)):
    row = (i // 3) * 2
    col = i % 3
...
out_path = OUT_DIR / "canary_bf_zf_3x3_5s_svd_projection_bars_pca_whiten_l2_d1024.png"
