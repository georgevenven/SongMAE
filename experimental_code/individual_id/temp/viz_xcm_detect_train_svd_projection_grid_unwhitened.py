...
fig.suptitle("xcm_detect_train, 5s, no whitening", fontsize=12)

for col, (stem, extracted) in enumerate(items):
...
out_path = OUT_DIR / "xcm_detect_train_3examples_5s_svd_projection_bars_no_whiten.png"
