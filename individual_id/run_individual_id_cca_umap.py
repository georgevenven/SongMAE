...
def main():
    ...
    parser.add_argument("--annotation_json", default="files/european_starling_annotations_unprefixed.json")
    parser.add_argument("--spec_dir", default="/media/george-vengrovski/disk2/specs/european_starling_64hop_32khz")
    ...
    parser.add_argument("--audio_params_stats_dir", default="/media/george-vengrovski/disk2/specs/european_starling_64hop_32khz")
